      ...
      <div className="flex flex-col md:flex-row justify-between gap-12 mb-12">
        ...
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-gray-500 leading-relaxed max-w-sm">
            Повече от салон – място за стил, увереност и грижа. Работим с
            внимание към всеки детайл, защото вярваме, че красотата започва с
        ...
        <div className="flex-1">
          <h3 className="text-lg font-semibold mb-6 text-gray-800 uppercase tracking-widest">
            Салон
          </h3>
