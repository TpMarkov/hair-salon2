  ...
  return (
    <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
        <div ref={imageRef}
          className="relative group overflow-hidden rounded-2xl shadow-2xl aspect-[4/3] bg-gray-100">
          <img
            src="/images/11.jpg"
            alt="about-image"
            loading="lazy"
      ...
      <div className="values-grid grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
        {values.map((v, idx) => (
          ...
          >
            <div
              className="w-12 h-12 bg-primary-gradient rounded-lg mb-6 flex items-center justify-center text-white font-bold text-xl">
              {idx + 1}
            </div>
