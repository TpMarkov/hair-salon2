...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // TODO: visit : https://dashboard.emailjs.com/admin update the email of the customer to receive email // Email templates / Send us an email /  add customer email - To Email
    emailjs
      .sendForm(
        "service_e8op97e",
        "template_mjytldn",
