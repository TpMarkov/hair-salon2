...
const MyProfile = () => {
  ...
  return userData && (
    <div ref={containerRef}
      className="min-h-[80vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-white">
      <div ref={cardRef}
            ...
            <div className="mt-6 sm:mt-20">
              {isEdit ?
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2 rounded-full font-semibold transition-all duration-300 shadow-md hover:shadow-lg active:scale-95 bg-green-500 text-white hover:bg-green-600`}
                >
                  <Check size={18} />
                  <span>ГОТОВО</span>
                </button>
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-6 py-2 rounded-full font-semibold transition-all duration-300 shadow-md hover:shadow-lg active:scale-95 bg-primary-gradient text-white`}
                >
                  <Edit2 size={18} />
            ...
            <div className="space-y-6 text-center sm:text-left">
              ...
              <div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
                ...
                <p className="text-xs text-gray-500 leading-relaxed">
                  Благодарим Ви, че избрахте нашия салон. Вашите данни се използват единствено за потвърждение на
                  резервации.
                </p>
              </div>
            </div>
