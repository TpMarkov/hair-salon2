...
const Navbar = () => {
  ...
  return (
      <>
        ...
        <nav
            className={`admin-nav ${sideBarCollapsed ? 'collapsed' : ''} ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
          <div className="admin-nav-inner flex flex-col h-full">
            {/* Logo Section */}
            <div className="admin-logo-container relative mb-4">
              <img className="w-12 md:w-24 cursor-pointer" src={"/images/logo.png"} alt="admin-logo"
                   onClick={() => navigate('/')}/>
