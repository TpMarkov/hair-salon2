  ...
  return (
      <DayPicker
          ...
          classNames={{
            ...
            month: "space-y-4 pt-5",
            caption: "flex justify-center pt-1 relative items-center h-10 w-full", // Added h-10 and w-full
            caption_label: "text-sm font-medium whitespace-nowrap text-center self-center ml-auto mr-auto",
            nav: "flex items-center justify-between absolute inset-x-0 top-10", // Use absolute inset-x-0 to pin buttons to caption edges
            button_previous: cn(
