...
import { Upload, PlusCircle, Scissors, Tag, FileText, LayoutList, Clock, Lock } from 'lucide-react';
      ...
      {import.meta.env.VITE_APP_BUNDLE === 'STANDARD' ? (
        <div className="flex flex-col items-center justify-center h-full min-h-[50vh] text-center p-8">
          ...
          <p className="text-gray-500 max-w-md">
            Service management is not available in the Standard plan. Please upgrade to Premium to add or edit services.
          </p>
        </div>
      ) : (
        <form
